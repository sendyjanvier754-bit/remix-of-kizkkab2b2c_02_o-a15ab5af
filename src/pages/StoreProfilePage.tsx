            ...
            <div className="flex items-center gap-2 md:gap-4 mb-1 md:mb-4">
              ...
              <div className="flex flex-row md:flex-col gap-2 md:gap-2 w-full md:w-auto justify-center md:justify-start">
                <Button
                  ...
                  className="flex-1 md:flex-none md:w-40 bg-white hover:bg-white/90 text-[#071d7f] font-semibold border-0 h-auto py-1 md:py-2 md:h-auto text-sm md:text-base rounded-full md:rounded-md px-0 md:px-4"
                >
                  <Heart className={`w-3.5 h-3.5 md:w-4 md:h-4 md:mr-2 ${isFollowing ? "fill-red-500 text-red-500" : "text-[#071d7f]"}`} />
                  <span className="hidden md:inline">{isFollowing ? "Siguiendo" : "Seguir"}</span>
                </Button>
                <Button
                  variant="outline"
                  className="flex-1 md:flex-none md:w-40 bg-white border-white text-[#071d7f] hover:bg-white/90 font-semibold h-auto py-1 md:py-2 md:h-auto text-sm md:text-base rounded-full md:rounded-md px-0 md:px-4"
                >
                  <MessageCircle className="w-3.5 h-3.5 md:w-4 md:h-4 md:mr-2 text-[#071d7f]" />
                ...
                <Button
                  ...
                  onClick={handleShare}
                >
                  <Share2 className="w-3.5 h-3.5 md:w-4 md:h-4 md:mr-2 text-[#071d7f]" />

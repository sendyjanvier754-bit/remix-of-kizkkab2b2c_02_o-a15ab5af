...
BEGIN
  ...
  WITH variantes_agrupadas AS (
    SELECT 
      ...
      MIN(o.id) AS order_id,  -- ✅ Cambiado de MAX a MIN
      SUBSTRING(MIN(o.id)::TEXT FROM 1 FOR 8) AS order_number,
      MIN(s.id) AS seller_store_id,  -- ✅ Cambiado de MAX a MIN
...
SELECT '✅ FUNCIÓN CORREGIDA (MIN en vez de MAX para UUIDs)' as resultado;

-- ============================================
-- SIVER MARKET 509 - COMPLETE SEED DATA
-- Contains ALL data for full migration
...
-- Sud-Est Department
INSERT INTO public.communes (id, name, code, department_id, rate_per_lb, delivery_fee, operational_fee, extra_department_fee, is_active) VALUES
('e5b11872-fa9e-4362-b7b3-76a1eb4a7603', 'Jacmel', 'JA', '2ff18f76-3a20-4daf-b880-49e6081782db', 3.00, 8.00, 3.00, 3.00, true),
('1796dc54-469d-4e85-852c-c6c5c5092b4f', 'Bainet', 'BY', '2ff18f76-3a20-4daf-b880-49e6081782db', 3.25, 9.00, 3.00, 3.50, true),
('98476a9b-2974-4d09-87c3-a906ef5ad73b', 'Marigot', 'MS', '2ff18f76-3a20-4daf-b880-49e6081782db', 3.50, 10.00, 3.50, 4.00, true)
ON CONFLICT (id) DO NOTHING;

-- Nippes Department
INSERT INTO public.communes (id, name, code, department_id, rate_per_lb, delivery_fee, operational_fee, extra_department_fee, is_active) VALUES
('47559a55-279f-4788-975e-1e72b7e91d22', 'Miragoâne', 'MR', '831203bf-eac8-4f4d-b883-515447e87681', 3.25, 9.00, 3.00, 3.50, true),
('9930c0cf-ea45-465d-8e23-8e16534db207', 'Anse-à-Veau', 'AS', '831203bf-eac8-4f4d-b883-515447e87681', 3.50, 10.00, 3.50, 4.00, true),
('c34f2a87-4e5c-4f8b-9c3d-7e8f9a0b1c2d', 'Petit-Goâve', 'PG', '831203bf-eac8-4f4d-b883-515447e87681', 3.00, 8.00, 3.00, 3.00, true)
ON CONFLICT (id) DO NOTHING;

-- Grand'Anse Department
INSERT INTO public.communes (id, name, code, department_id, rate_per_lb, delivery_fee, operational_fee, extra_department_fee, is_active) VALUES
('10d8be02-dff5-43d6-a421-79376f93ad1b', 'Jérémie', 'JE', '285868d9-50e5-45b2-aacf-820d17eadcfe', 3.50, 10.00, 3.50, 4.50, true),
('d4c11663-1fb0-4654-acc7-0e0af3fdd493', 'Dame-Marie', 'DA', '285868d9-50e5-45b2-aacf-820d17eadcfe', 4.00, 12.00, 4.00, 5.00, true),
('ca0408a4-294e-4852-8b23-0fc852b890a7', 'Anse-d''Hainault', 'AN', '285868d9-50e5-45b2-aacf-820d17eadcfe', 4.00, 12.00, 4.00, 5.00, true)
ON CONFLICT (id) DO NOTHING;

-- ============================================
-- 10. B2B MARGIN RANGES (Protection Rule)
-- ============================================
...
-- ============================================
-- 13. MARKETPLACE SECTION SETTINGS
-- ============================================
...
-- ============================================
-- 18. ATTRIBUTE OPTIONS (Sizes - Clothing)
-- ============================================
...
-- ============================================
-- 19. ATTRIBUTE OPTIONS (Sizes - Shoes)
-- ============================================
INSERT INTO public.attribute_options (id, attribute_id, value, display_value, is_active) VALUES

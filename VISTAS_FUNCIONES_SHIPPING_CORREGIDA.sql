...
-- ============================================================================
-- VISTA 2: Costos de envío para carrito (versión simplificada)
-- ============================================================================
...
-- Calcular totales del carrito SIN window functions
cart_totals AS (
  SELECT 
...
SELECT
  ...
  (SELECT weight_rounded_kg FROM public.calculate_shipping_cost_cart(
    ...
    ct.total_weight_kg,
    (SELECT id FROM public.shipping_type_configs WHERE type = 'STANDARD' AND is_active = TRUE LIMIT 1),
    COALESCE(ct.has_oversize, FALSE),
    ct.max_length_cm,
    ct.max_width_cm,
    ct.max_height_cm
...
-- ============================================================================
-- PRUEBAS: Ver datos de las vistas (descomentar para ejecutar)
-- ============================================================================
